...
import 'package:flutter_app/sliver/AddGoodsAddress.dart';
...
class Items {
  ...
  static getGoodItem(BuildContext context, int index, String img,
      {bool isShow = false}) {
                ...
                ClipRRect(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Image.asset(
                        isShow ? 'assets/imagers/owner_subscript.png' : '',
                        height: 62,
                        width: 62,
                      )
                    ],
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ClipRRect(
                      child: Image.network(
                        'https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&qual'
                        'ity=100&size=b4000_4000&sec=1578989166&di=8e66236a852a76b68b651efa8780c61e&src=ht'
                        'tp://img011.hc360.cn/m8/M09/5E/90/wKhQpVXcIsqECsh3AAAAAG2-m0s703.jpg',
                        height: 80,
                        width: 80,
                        fit: BoxFit.cover,
                      ),
  ...
  //收益列表信息
  static getInfoItem(BuildContext context) {
    return Padding(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  Expanded(child: Text('I181387223140025')),
                  Text(
                    '订单',
                    style: TextStyle(fontSize: 14, color: Color(0xff8c8c8c)),
                  ),
              ...
              Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      '冻结',
                      style: TextStyle(fontSize: 13, color: Color(0xff0019FF)),
                    ),
                  ),
                  Text(
                    '2018-08-11 09:02:32',
