...
//          style: TextStyle(decorationColor: Color(0x00ff0000)),
//        ),
//      ),
//      body: Center(
...
//            TextField(
//              style: TextStyle(
//                  color: Colors.deepOrange, fontSize: 20, height: 100),
...
import 'MainPagerTest.dart';
import 'newImagerPager.dart';
import 'dart:io';
void main() {
  runApp(new MainPagers());
